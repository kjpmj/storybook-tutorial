...
var style = css(_templateObject(), palette.main()[5], palette.main()[4], palette.main()[6]);
var themes = {
  primary: css(_templateObject2(), palette.main()[5], palette.main()[4], palette.main()[6], palette.gray[5]),
  secondary: css(_templateObject3(), palette.gray[2], palette.gray[8], palette.gray[8], palette.gray[1], palette.gray[3]),
  tertiary: css(_templateObject4(), palette.main()[5], palette.main()[5], palette.main()[0], palette.main()[1], palette.gray[3])
};
var sizes = {
...
/**
 * 여러개의 `Button` 컴포넌트를 보여주고싶거나, 버튼을 우측에 정렬하고 싶을 땐 `ButtonGroup` 컴포넌트를 사용하세요.
 */
...
var labelStyle = css(_templateObject$3());
var labelSpanStyle = css(_templateObject2$2(), palette.gray[6]);
var borderSpanStyle = css(_templateObject3$2(), palette.main()[5]);
var style$1 = css(_templateObject4$2(), palette.gray[6], palette.gray[7], palette.main()[5], palette.gray[6], palette.main()[5]);
var themes$1 = {
  primary: css(_templateObject5$1(), palette.gray[7]),
  secondary: css(_templateObject6$1(), palette.teal[5]),
  tertiary: css(_templateObject7$1(), palette.orange[5])
};

export { Button, ButtonGroup, Dialog, Icon, Input };
